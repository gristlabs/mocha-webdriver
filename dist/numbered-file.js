...
exports.createNumberedFile = void 0;
 ...
 */
async function createNumberedFile(template) {
    const TOKEN = "{N}";
    ...
    for (let n = 1;; n++) {
        ...
        try {
            ...
            if (err.code === 'EEXIST' && n < MAX_N_TOKEN) {
                continue;
            }
            throw err;
        }
...
exports.createNumberedFile = createNumberedFile;
//# sourceMappingURL=numbered-file.js.map